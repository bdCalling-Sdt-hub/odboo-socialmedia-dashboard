...
// Use FaLock for the locked icon
        ...
        <table className="w-full table-auto">
          <thead className="bg-green-100">
            <tr>
              ...
              <th className="px-4 py-2 text-sm font-semibold text-gray-600 text-center">Joining Date</th>
          ...
          <tbody>
            {sessions.map((session, index) => (
              <tr key={index} className="border-b hover:bg-gray-50">
                ...
                <td className="px-4 py-2 text-sm text-gray-800 text-center">{session.email}</td>
                <td className="px-4 py-2 text-sm text-gray-800 text-center">{session.location}</td>
                <td className="px-4 py-2 text-sm text-gray-800 text-center">{session.Total}</td>
                ...
                <td className="px-4 py-2 text-sm text-gray-800 text-center">
                  {/* Show the red lock if the session is blocked */}
