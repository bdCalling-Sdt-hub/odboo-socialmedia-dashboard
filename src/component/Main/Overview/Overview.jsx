    ...
    return (
        <div className="w-full container mx-auto bg-white space-y-6">
            ...
            <div className="p-6 space-y-6 bg-white">
                ...
                <div className="lg:flex gap-8 ">
                    {/* Total User */}
                    <div className="w-full sm:w-1/2 md:w-1/4 p-4 border border-[#1EB9C6] rounded-lg shadow-md">
                        <div className="flex items-center gap-4">
                            <span className="text-4xl text-[#1EB9C6]"><img src={users} alt="Total Users" /></span>
                            <div>
                                <span className="text-xl font-bold text-[#1EB9C6]">Total User</span>
                                <div className="text-2xl text-[#1EB9C6] font-bold">656</div>
                            </div>
                    ...
                    <div className="w-full sm:w-1/2 md:w-1/4 p-4 border border-[#1EB9C6] rounded-lg shadow-md">
                        <div className="flex items-center gap-4">
                            <span className="text-4xl text-[#1EB9C6]"><img src={userCheck} alt="Total Customers" /></span>
                            <div>
                                <span className="text-xl font-bold text-[#1EB9C6]">Total Customers</span>
                                <div className="text-2xl text-[#1EB9C6] font-bold">656</div>
                            </div>
                    ...
                    <div className="w-full sm:w-1/2 md:w-1/4 p-4 border border-[#1EB9C6] rounded-lg shadow-md">
                        <div className="flex items-center gap-4">
                            <span className="text-4xl text-[#1EB9C6]"><img src={userX} alt="Total Company" /></span>
                            <div>
                                <span className="text-xl font-bold text-[#1EB9C6]">Total Company</span>
                                <div className="text-2xl text-[#1EB9C6] font-bold">656</div>
                            </div>
                    ...
                    <div className="w-full sm:w-1/2 md:w-1/4 p-4 border border-[#1EB9C6] rounded-lg shadow-md">
                        <div className="flex items-center gap-4">
                            <span className="text-4xl text-[#1EB9C6]"><img src={User} alt="Total Provider" /></span>
                            <div>
                                <span className="text-xl font-bold text-[#1EB9C6]">Total Provider</span>
                                <div className="text-2xl text-[#1EB9C6] font-bold">656</div>
                            </div>
            ...
            <div className="lg:flex  gap-8 p-6">
                {/* User Overview Graph */}
                <div className="w-full sm:w-1/2 lg:w-1/2 p-4 border border-[#1EB9C6] rounded-lg shadow-md">
                    <h3 className="text-xl font-semibold text-[#1EB9C6] mb-4">User Overview</h3>
                    <Line data={userOverviewData} options={options} />
                </div>
