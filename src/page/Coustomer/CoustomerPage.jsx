...
//           <div className="bg-white border border-[#1EB9C6] p-6 rounded-lg shadow-lg max-w-sm w-full">
//             <div className="flex flex-col items-center">
//               <img src="/path-to-your-image.jpg" alt="Customer" className="w-32 h-32 rounded-full mb-4" />
//               <h2 className="text-xl font-bold">Customer Name:{selectedCustomer.name}</h2>
//               <p className="text-gray-600">Customer email:{selectedCustomer.email}</p>
...
//                 onClick={() => alert('Customer Blocked')}
//               >
//                 Block
//               </button>
//             </div>
...
const CoustomerPage = () => {
  const [customers, setCustomers] = useState([
    { name: "Khairul Bashar", email: "abc@gmail.com", dateJoined: "2 March, 2025", bookings: 14, status: "Aktiv" },
    { name: "Anika Alam", email: "anika@gmail.com", dateJoined: "2 March, 2025", bookings: 12, status: "Aktiv" },
    { name: "John Doe", email: "john@example.com", dateJoined: "1 March, 2025", bookings: 8, status: "Aktiv" },
